...
Type type, IDataReader reader, int startBound = 0, int length = -1, bool returnNullIfFirstMissing = false
    ...
    /// </summary>
     class DynamicParameters : SqlMapper.IDynamicParameters
    {
...
#pragma warning restore 612, 618
    ...
    /// </summary>
    sealed  class DbString : SqlMapper.ICustomQueryParameter
    {
        /// <summary>
    ...
    /// </summary>
    sealed class CustomPropertyTypeMap : SqlMapper.ITypeMap
    {
        private readonly Type _type;
